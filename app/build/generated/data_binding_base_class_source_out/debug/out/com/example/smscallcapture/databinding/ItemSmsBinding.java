...
public final class ItemSmsBinding implements ViewBinding {
  ...
  private ItemSmsBinding(@NonNull LinearLayout rootView, @NonNull TextView textDate,
      @NonNull TextView textMessage, @NonNull TextView textSender, @NonNull TextView textStatus) {
  ...
  public static ItemSmsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemSmsBinding((LinearLayout) rootView, textDate, textMessage, textSender,
          textStatus);
    }
