...
public abstract interface CallDao {
    ...
    @androidx.room.Query(value = "SELECT MAX(startTime) FROM calls")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object getMaxStartTime(@org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super java.lang.Long> $completion);
}